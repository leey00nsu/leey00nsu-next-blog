...
공식문서: [https://tanstack.com/query/latest/docs/react/guides/optimistic-updates](https://tanstack.com/query/latest/docs/react/guides/optimistic-updates)

좋아요를 예시로 들었을 때, 기존 방식과의 차이는 다음과 같습니다.
...
| :--------------------------------------------------: | :--------------------------------------------------: |
| <Image alt='optimistic-X' src='./optimistic-X.gif'/> | <Image alt='optimistic-O' src='./optimistic-O.gif'/> |
