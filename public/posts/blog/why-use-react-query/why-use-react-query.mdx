...
![description](/public/posts/blog/why-use-react-query/description.png)
...
![query-structure](/public/posts/blog/why-use-react-query/query-structure.png)

실제로 적용하면 입찰과 동시에 경매 페이지의 내용(차트)도 함께 변하는 것을 볼 수 있습니다.

![result](/public/posts/blog/why-use-react-query/result.gif)
